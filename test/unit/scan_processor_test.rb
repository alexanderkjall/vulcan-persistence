...
describe 'scan_processor' do
  it 'should process a scan' do
    checks_params = { scan: { checks: [{ check: { checktype_name: 'tls', target: 'localhost', tag:'tag1' } },
    ...
    assert_equal(@checks,[
                   { 'checktype_id' => '', 'checktype_name' => 'tls', 'target' => 'localhost', 'options' => '', 'webhook' => '', 'tag' => 'tag1', 'jobqueue_id' => nil, 'jobqueue_name' => nil},
                   { 'checktype_id' => '', 'checktype_name' => 'tls', 'target' => 'www.example.com', 'options' => '', 'webhook' => '', 'tag' => 'tag2', 'jobqueue_id' => nil, 'jobqueue_name' => nil }
                 ])
  end
